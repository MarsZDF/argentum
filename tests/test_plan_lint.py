...
class TestPlanLinter:
    ...
    def test_e001_completely_invalid_tool(self):
        ...
        """
        plan = {"steps": [{"id": "step1", "tool": "xyz_invalid_tool", "parameters": {}}]}
    ...
    def test_e002_missing_required_parameters(self):
            ...
            "steps": [
                {
                    "id": "step1",
                    "tool": "search_web",
                    "parameters": {"max_results": 10},  # Missing required 'query' parameter
                }
            ]
        }
        ...
        missing_param_issue = next(
            i for i in result.issues if "Missing required parameter 'query'" in i.message
        )
    ...
    def test_e003_dependency_errors(self):
        ...
        assert result.has_errors()
        circular_issues = [
            i for i in result.issues if i.code == "E003" and "Circular dependency" in i.message
        ]
    ...
    def test_complex_rag_pipeline(self):
        ...
        rag_tools = {
            ...
            "extract_text": {"parameters": {"documents": {"type": "array", "required": True}}},
            "generate_response": {
                "parameters": {
    ...
    def test_sarif_output_format(self):
        ...
        plan = {
            "steps": [
                {"id": "step1", "tool": "invalid_tool", "parameters": {"invalid_param": "value"}}
            ]
        }
    ...
    def test_human_readable_output(self):
        ...
        plan = {
            "steps": [
                {"id": "step1", "tool": "search_webb", "parameters": {"query": "test"}},  # Error
                {
                    "id": "step2",
