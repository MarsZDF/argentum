...
class TestSecretsDetection:
    ...
    def test_basic_secrets_detection(self):
        ...
        data_with_secrets = {
            ...
            "database": {"password": "secret123", "connection": "bearer_token_xyz"},
        }
            ...
            "config": {
                "auth": {
                    "tokens": {
                        ...
                        "aws": {"access_key": "AKIA1234567890", "secret": "secret_key_xyz"},
                    }
                }
            }
        }
...
class TestSecurityValidator:
    ...
    def test_plan_lint_validation(self):
        ...
        plan = {"steps": [{"id": "step1", "tool": "test_tool", "parameters": {"param": "value"}}]}
