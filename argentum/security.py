            ...
            for i, step in enumerate(steps):
                if "parameters" in step:
                    ...
                    validate_collection_size(
                        params, self.config.max_step_parameters, f"step {i} parameters"
                    )
...
def secure_handoff(
    ...
    get_validator().validate_handoff_input(
        from_agent, to_agent, context_summary, artifacts, metadata
    )
