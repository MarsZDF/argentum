...
class HandoffProtocol:
        ...
        if cost_context:
            ...
            if tokens_used and processing_cost:
                ...
                efficiency_score = min(
                    1.0, context_complexity / (tokens_used * processing_cost * 1000)
                )
    ...
    def analyze_handoff_efficiency(self, handoff: Handoff) -> Dict[str, Any]:
        ...
        if handoff.processing_cost and handoff.artifacts:
            efficiency_report["cost_per_artifact"] = handoff.processing_cost / len(
                handoff.artifacts
            )
    ...
    def get_cost_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "efficiency_scores": [
                cost.get("efficiency_score", 0.0) for cost in self._handoff_costs.values()
            ],
        }
